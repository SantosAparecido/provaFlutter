    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Consumer<Produto>(
          builder: (context, produtos, child) => Container(
                ...
                return Dismissible(
                    ...
                    onDismissed: (direction) {
                      if (direction == DismissDirection.startToEnd) {
                        ...
                        Provider.of<Carrinho>(context)
                            .adicionarAoCarrinho(produtos.getProduto(index));
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            ...
                            content: direction == DismissDirection.startToEnd
                                ? Text(
                                    "Deseja colocar este item em seu carrinho?")
                                : Text(
                                    "Deseja deletar este item de sua lista?"),
                            actions: <Widget>[
                              ElevatedButton(
                                onPressed: () =>
